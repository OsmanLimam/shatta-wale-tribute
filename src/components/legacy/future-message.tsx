    ...
    <Section id="future-message" tone="ink">
      <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
        <div className="lg:col-span-5">
          <Reveal>
            <div className="font-mono-caps mb-5 text-gold">14 — A Message For The Future</div>
          </Reveal>
          <Reveal delay={0.05}>
          ...
          <Reveal delay={0.1}>
            <div className="mt-8">
              <LegacyImage
                src="/images/wendy-shay/portrait-gold-gown-window.jpg"
                alt="Wendy Shay — a moment held in time, looking toward the future."
